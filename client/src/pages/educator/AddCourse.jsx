...
const AddCourse = () => {
    ...
    const handleSubmit = async (e) => {
        try {
            e.preventDefault()
            if (!image) {
                toast.error('Image Not Delected')
            }
    ...
    return (
        <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pb-0'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
                ...
                <div className='flex items-center justify-between flex-wrap'>
                    ...
                    <div className='flex md:flex-row flex-col items-center gap-3'>
                        ...
                        <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
                            <img src={assets.file_upload_icon} alt="" className='p-3 bg-blue-500 hover:bg-green-500 rounded' />
                            <input
                ...
                <button type='submit' className='bg-green-500 text-white w-max py-2.5 px-8 cursor-pointer rounded my-4'>
                    ADD
                </button>
            </form>
        </div>
