...
const CoursesDetails = () => {
    ...
    const {
        ...
        calculateChapterTime, backendUrl,
        userData, getToken
            ...
            <div className='relative flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
                ...
                >
                    ...
                    <div className='p-5'>
                        ...
                        <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded-md bg-green-600 text-white font-medium hover:bg-yellow-500'>
