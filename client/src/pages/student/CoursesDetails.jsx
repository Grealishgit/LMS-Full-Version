        ...
        <>
            <div className='relative flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
                ...
                <div className='max-w-xl z-10 text-gray-500'>
                    <h1 className='md:text-3xl text-md font-semibold text-gray-800'>
                    ...
                    <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                        ...
                        <p className='text-red-500'>({courseData.courseRatings.length}
                            {courseData.courseRatings.length > 1 ? ' ratings' : ' rating'})</p>
                        <p className='text-green-500'>{courseData.enrolledStudents.length}{courseData.enrolledStudents.length > 1 ? ' Students' : ' Student'}</p>
                    </div>
                    <p className='text-sm'>Course by <span className='text-green-600 underline'>Hunter</span></p>
                                                    ...
                                                    <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-md'>
                                                        ...
                                                        <div className='flex gap-2'>
                                                            {lecture.isPreviewFree && <p
                                                                ...
                                                                className='text-green-500 cursor-pointer'>Preview</p>}
                    ...
                    <div className='py-20 text-sm md:text-md'>
                ...
                >
                    {
                        playerData ?
                            <YouTube videoId={playerData.videoId} options={{
                                playerVars: {
                                    autoplay: 1
                                }
                    ...
                    <div className='p-5'>
                        <div className='flex items-center gap-2'>
                            ...
                            <p className='text-green-500'> <span className='font-medium'>5 days</span> left at this price!</p>
                        </div>
                        <div className='flex gap-3 items-center pt-2'>
                            <p className='text-gray-800 md:text-4xl text-2xl font-semibold'>{currency}{(courseData.coursePrice - courseData.discount * courseData.coursePrice / 100).toFixed(2)}</p>
                            <p className='md:text-lg text-red-500 line-through'>{currency}{courseData.coursePrice}</p>
                        ...
                        <button className='md:mt-6 mt-4 w-full py-3 rounded-md bg-green-600 text-white font-medium hover:bg-yellow-500'>
                            {isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}
                        </button>

                        <div className='pt-6'>
                            <p className='md:text-xl text-lg font-medium text-gray-800'>What's in the Course?</p>
                            <ul className='ml-4 pt-2 tet-sm md;text-md list-disc text-gray-500'>
