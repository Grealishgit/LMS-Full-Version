...
const Player = () => {
    ...
    const handleRate = async (rating) => {
        try {
            ...
            const { data } = await axios.post(
                ...
                { courseId, rating, userId: userData._id },
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    return courseData ? (
        <>
            <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:not-first-of-type:px-36'>
                {/*Left column */}
                                    ...
                                    <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                                        {chapter.chapterContent.map((lecture, i) => (
                                            <li key={i} className='flex items-start gap-2 py-1'>
                                                <img src={progressData?.lectureCompleted?.includes(lecture.lectureId)
                                                ...
                                                <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-md'>
                                                    ...
                                                    <div className='flex gap-2'>
                                                        {lecture.lectureUrl && <p
                                                            ...
                                                            className='text-green-500 cursor-pointer'>Watch</p>}
